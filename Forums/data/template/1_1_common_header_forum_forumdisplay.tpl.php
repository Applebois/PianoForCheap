...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1511324582, '1', './data/template/1_1_common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1511324582, '1', './data/template/1_1_common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1511324582, '1', './data/template/1_1_common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
;?>
...
<div class="xi1 bm bm_c">
    Please select <a href="<?php echo $_G['siteurl'];?>forum.php?mobile=yes">Into the mobile phone version</a> <span class="xg1">|</span> <a href="<?php echo $_G['setting']['mobile']['nomobileurl'];?>">Continue to access the computer ver.</a>
</div>
...
You frequently visit <?php echo $_G['setting']['bbname'];?>, Try to add to the desktop, Access to more convenient!
<a href="javascript:;" id="shortcuttip">Add <?php echo $_G['setting']['bbname'];?> To the desktop</a>
...
<a href="javascript:;" id="switchwidth" onclick="widthauto(this)" title="<?php if(widthauto()) { ?>Switch to narrow ver.<?php } else { ?>Switch to wide ver.<?php } ?>" class="switchwidth"><?php if(widthauto()) { ?>Switch to narrow ver.<?php } else { ?>Switch to wide ver.<?php } ?></a>
<?php } if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});">Switching style</a><?php } if(check_diy_perm($topic)) { ?>
<?php echo $diynav;?>
<?php } ?>
</div>
</div>
...
<li><a href="home.php?mod=space&amp;do=pm" id="pm_ntc" style="background-repeat: no-repeat; background-position: 0 50%;"><em class="prompt_news<?php if(empty($_G['member']['newpm'])) { ?>_0<?php } ?>"></em>PM</a></li>

<li><a href="home.php?mod=follow&amp;do=follower"><em class="prompt_follower<?php if(empty($_G['member']['newprompt_num']['follower'])) { ?>_0<?php } ?>"></em>My bookmarked<?php if($_G['member']['newprompt_num']['follower']) { ?>(<?php echo $_G['member']['newprompt_num']['follower'];?>)<?php } ?></a></li>

<?php if($_G['member']['newprompt'] && $_G['member']['newprompt_num']['follow']) { ?>
<li><a href="home.php?mod=follow"><em class="prompt_concern"></em>My bookmarked(<?php echo $_G['member']['newprompt_num']['follow'];?>)</a></li>
...
<li class="ignore_noticeli"><a href="javascript:;" onclick="setcookie('ignore_notice', 1);hideMenu('myprompt_menu')" title="Temporarily not remind"><em class="ignore_notice"></em></a></li>
<?php } ?>
</ul>
...
Please <br /><a class="xi2" href="member.php?mod=connect"><strong>Improve the account information</strong></a> or <a href="member.php?mod=connect&amp;ac=bind" class="xi2 xw1"><strong>Bind an existing account</strong></a><br />After using the shortcut nav
</div>
<?php } else { ?>
<div class="ptm pbw hm">
Please <a href="javascript:;" class="xi2" onclick="lsSubmit()"><strong>Login</strong></a> After using the shortcut navigation<br />No Account? <a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" class="xi2 xw1"><?php echo $_G['setting']['reglinkname'];?></a>
</div>
...
<div id="nv">
<a href="javascript:;" id="qmenu" onmouseover="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})">Quick Nav</a>
...
$slist[forumfid] = <<<EOF
<li><a href="javascript:;" rel="curforum" fid="{$_G['fid']}" >Forum</a></li>
EOF;
...
$slist[forum] = <<<EOF
<li><a href="javascript:;" rel="forum" class="curtype">Posts</a></li>
EOF;
