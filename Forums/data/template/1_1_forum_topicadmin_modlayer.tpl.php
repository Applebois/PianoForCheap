...
<a class="cp" href="javascript:;" title="Minimize" onclick="$('mdly').className='cpd'">Minimize</a>
<label><input type="checkbox" name="chkall" class="pc" onclick="if(!($('mdct').innerHTML = modclickcount = checkall(this.form, 'moderate'))) {$('mdly').style.display = 'none';}" />Select</label>
<h6><span>Selected</span><strong onclick="$('mdly').className='';" onmouseover="this.title='Maximize'" id="mdct"></strong><span>Piece: </span></h6>
<p>
<?php if($_G['group']['allowdelpost']) { ?>
<strong><a href="javascript:;" onclick="tmodthreads(3, 'delete');return false;">Del</a></strong>
...
<strong><a href="javascript:;" onclick="tmodthreads(2, 'type');return false;">Category</a></strong>
<?php } if($_G['forum']['status'] == 3 && in_array($_G['adminid'], array('1','2'))) { ?>
<span class="pipe">|</span>
<strong><a href="javascript:;" onclick="tmodthreads(5, 'recommend_group');return false;">Recommend to Forum</a></strong>
...
<a href="javascript:;" onclick="tmodthreads(1, 'stick');return false;">Top</a>
...
<a href="javascript:;" onclick="tmodthreads(3, 'bump');return false;">Up/Down</a>
<?php } if($_G['forum']['status'] != 3 && $_G['group']['allowclosethread']) { ?>
<a href="javascript:;" onclick="tmodthreads(4);return false;">Close/Open</a>
<?php } ?>
</p>
</div>