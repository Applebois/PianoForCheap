...
?><?php
$return = <<<EOF
<div id="g_up{$post['pid']}_menu" class="tip tip_4" style="display: none;"><div class="tip_horn"></div><div class="tip_c">{$post['authortitle']}, Credits {$post['credits']}, From the next level needed {$post['upgradecredit']} Credits</div></div>
EOF;
?><?php 
$run = 1;
return $return;
