...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1511829338, '1', './data/template/1_1_member_login.tpl.php', './template/default', 'member/login')
...
<a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" class="xi2">Not have an account? <a href="member.php?mod=<?php echo $_G['setting']['regname'];?>"><?php echo $_G['setting']['reglinkname'];?></a></a>
</span>
<h3 class="xs2">Login</h3>
</div>
<div>
<?php } ?>
...
<?php if(!empty($_GET['infloat'])) { if(!empty($_GET['guestmessage'])) { ?>You need to be logged in in order to continue the operation<?php } elseif($auth) { ?>Please add the following login info<?php } else { ?>User Login<?php } } ?>
</em>
<span><?php if(!empty($_GET['infloat']) && !isset($_GET['frommessage'])) { ?><a href="javascript:;" class="flbc" onclick="hideWindow('<?php echo $_GET['handlekey'];?>', 0, 1);" title="Close">Close</a><?php } ?></span>
</h3>
...
<tr>
<th>
<?php if($this->setting['autoidselect']) { ?><label for="username_<?php echo $loginhash;?>">Account:</label><?php } else { ?>
...
<table>
<tr>
<th><label for="password3_<?php echo $loginhash;?>">Password:</label></th>
...
<td class="tipcol"><a href="javascript:;" onclick="display('layer_login_<?php echo $loginhash;?>');display('layer_lostpw_<?php echo $loginhash;?>');" title="Forgot Password">Forgot Password</a></td>
</tr>
</table>
</div>
...
<option value="0"><?php if($questionexist) { ?>Security Question<?php } else { ?>Security Question(Not set Please ignore)<?php } ?></option>
...
<tr>
<th></th>
<td><label for="cookietime_<?php echo $loginhash;?>"><input type="checkbox" class="pc" name="cookietime" id="cookietime_<?php echo $loginhash;?>" tabindex="1" value="2592000" <?php echo $cookietimecheck;?> />Auto login</label></td>
</tr>
</table>
</div>
...
<td>
<?php if($this->setting['sitemessage']['login'] && empty($_GET['infloat'])) { ?><a href="javascript:;" id="custominfo_login_<?php echo $loginhash;?>" class="y">&nbsp;<img src="<?php echo IMGDIR;?>/info_small.gif" alt="Faq" class="vm" /></a><?php } if(!$this->setting['bbclosed'] && empty($_GET['infloat'])) { ?><a href="javascript:;" onclick="ajaxget('member.php?mod=clearcookies&formhash=<?php echo FORMHASH;?>', 'returnmessage_<?php echo $loginhash;?>', 'returnmessage_<?php echo $loginhash;?>');return false;" title="Clear cookies" class="y">Clear cookies</a><?php } ?>
</td>
</tr>
</table>
</div>
...
<h3 class="flb">
<em id="returnmessage3_<?php echo $loginhash;?>">Forgot Password</em>
<span><?php if(!empty($_GET['infloat']) && !isset($_GET['frommessage'])) { ?><a href="javascript:;" class="flbc" onclick="hideWindow('login')" title="Close">Close</a><?php } ?></span>
</h3>
...
<em>User Login</em>
<span><a href="javascript:;" class="flbc" onclick="hideWindow('login')" title="Close">Close</a></span>
<?php } ?>
</h3>
