...
0
|| checktplrefresh('./template/default/member/register.htm', './template/default/common/seccheck.htm', 1511325635, '1', './data/template/1_1_member_register.tpl.php', './template/default', 'member/register')
...
Abandon activated, Now<a href="member.php?mod=<?php echo $_G['setting']['regname'];?>"><?php echo $_G['setting']['reglinkname'];?></a>
<?php } else { ?>
<a href="member.php?mod=logging&amp;action=login&amp;referer=<?php echo rawurlencode($dreferer); ?>" onclick="showWindow('login', this.href);return false;" class="xi2">Have an account? Login now</a>
<?php } ?>
</span>
<h3 id="layer_reginfo_t" class="xs2">
<?php if($_GET['action'] != 'activation') { ?><?php echo $this->setting['reglinkname'];?><?php } else { ?>Need to activate your account<?php } ?>
</h3>
</div>
...
<td class="tipcol"><i id="tip_<?php echo $this->setting['reginput']['email'];?>" class="p_tip">Please enter a correct email address</i><kbd id="chk_<?php echo $this->setting['reginput']['email'];?>" class="p_chk"></kbd></td>
</tr>
</table>
<table>
<tr>
<th>&nbsp;</th>
<td class="tipwide">
Registration need to verify the mailbox, be sure to fill in the correct mailbox, please check your email after submission. <br /> You may need to wait a few minutes to receive e-mail, Inbox, please check the spam box.
</td>
</tr>
</table>
...
<table>
<tr>
<th><label for="invitecode">Invitation Code:</label></th>
...
<table>
<tr>
<th><span class="rq">*</span><label for="<?php echo $this->setting['reginput']['username'];?>">User name:</label></th>
...
<td class="tipcol"><i id="tip_<?php echo $this->setting['reginput']['username'];?>" class="p_tip">The username is 3-15 characters</i><kbd id="chk_<?php echo $this->setting['reginput']['username'];?>" class="p_chk"></kbd></td>
</tr>
</table>
</div>
...
<td class="tipcol"><i id="tip_<?php echo $this->setting['reginput']['password'];?>" class="p_tip">Please fill in your password<?php if($_G['setting']['pwlength']) { ?>, Minimum length of <?php echo $_G['setting']['pwlength'];?>  Characters<?php } ?></i><kbd id="chk_<?php echo $this->setting['reginput']['password'];?>" class="p_chk"></kbd></td>
</tr>
</table>
</div>
...
<table>
<tr>
<th><span class="rq">*</span><label for="<?php echo $this->setting['reginput']['password2'];?>">Confirm Password:</label></th>
<td><input type="password" id="<?php echo $this->setting['reginput']['password2'];?>" name="" size="25" tabindex="1" value="" class="px" required /></td>
<td class="tipcol"><i id="tip_<?php echo $this->setting['reginput']['password2'];?>" class="p_tip">Please enter the password again</i><kbd id="chk_<?php echo $this->setting['reginput']['password2'];?>" class="p_chk"></kbd></td>
</tr>
</table>
</div>
...
<table>
<tr>
<th><span class="rq">*</span><label for="regmessage">Register reason:</label></th>
<td><input id="regmessage" name="regmessage" class="px" autocomplete="off" size="25" tabindex="1" required /></td>
<td class="tipcol"><i id="tip_regmessage" class="p_tip">You fill out the registration reason is as important reference application for registration, please fill out.</i></td>
</tr>
</table>
</div>
...
<?php } } ?>
function showBBRule() {
showDialog($('layer_bbrule').innerHTML, 'info', '<?php echo addslashes($this->setting['bbname']);; ?> Terms of Service');
