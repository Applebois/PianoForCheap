...
0
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/header.htm', 1511324902, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/pubsearch.htm', 1511324902, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/thread_list.htm', 1511324902, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/footer.htm', 1511324902, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/common/header_common.htm', 1511324902, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
;?>
...
<div class="z">
<a href="./" id="navs" class="showmenu xi2" onmouseover="showMenu(this.id)">Back Home</a>
</div>
<div class="y">
<?php if($_G['uid']) { ?>
<strong><a href="home.php?mod=space" target="_blank" title="Visit my space"><?php echo $_G['member']['username'];?></a></strong>
<a href="javascript:;" id="myspace" class="showmenu xi2" onmouseover="showMenu(this.id);">Quick Nav</a>
<?php if(!empty($_G['setting']['pluginhooks']['global_usernav_extra1'])) echo $_G['setting']['pluginhooks']['global_usernav_extra1'];?>
<a href="home.php?mod=spacecp">Setting</a>
<?php if($_G['uid'] && ($_G['group']['radminid'] == 1 || getstatus($_G['member']['allowadmincp'], 1))) { ?><a href="admin.php" target="_blank">Manage Center</a><?php } ?>
...
<span class="y">
<a href="javascript:;" id="quick_sch" class="showmenu" onmouseover="delayShow(this);">Fast</a>
<?php if(CURMODULE == 'forum') { ?>
<a href="search.php?mod=forum&amp;adv=yes<?php if($keyword) { ?>&amp;srchtxt=<?php echo $keywordenc;?><?php } ?>">Advanced</a>
<?php } ?>
</span>
...
<a href="javascript:;" id="quick_sch" class="showmenu" onmouseover="delayShow(this);">Fast</a>
<?php if(CURMODULE == 'forum') { ?>
<a href="search.php?mod=forum&amp;adv=yes">Advanced</a>
<?php } ?>
</span>
...
>Scouring posts</a>
EOF;
?><?php } echo implode("", $slist);; ?><a href="search.php?mod=user<?php if($keyword) { ?>&amp;srchtxt=<?php echo $keywordenc;?>&amp;searchsubmit=yes<?php } ?>"<?php if(CURMODULE == 'user') { ?> class="a"<?php } ?>>User</a>
</td>
</tr>
<tr>
<td>
...
<td class="td_srchbtn"><input type="hidden" name="searchsubmit" value="yes" /><button type="submit" id="scform_submit" value="true"><strong>Search</strong></button></td>
</tr>
</table>
</td>
</tr>
...
<li><a href="search.php?mod=forum&amp;srchfrom=3600&amp;searchsubmit=yes">1 New posts within the hour</a></li>
<li><a href="search.php?mod=forum&amp;srchfrom=14400&amp;searchsubmit=yes">4 New posts within the hour</a></li>
<li><a href="search.php?mod=forum&amp;srchfrom=28800&amp;searchsubmit=yes">8 New posts within the hour</a></li>
<li><a href="search.php?mod=forum&amp;srchfrom=86400&amp;searchsubmit=yes">24 New posts within the hour</a></li>
<li><a href="search.php?mod=forum&amp;srchfrom=604800&amp;searchsubmit=yes">1 Week period post</a></li>
<li><a href="search.php?mod=forum&amp;srchfrom=2592000&amp;searchsubmit=yes">1 month period post</a></li>
<li><a href="search.php?mod=forum&amp;srchfrom=15552000&amp;searchsubmit=yes">6 month period post</a></li>
<li><a href="search.php?mod=forum&amp;srchfrom=31536000&amp;searchsubmit=yes">12 month period post</a></li>
</ul>
...
EOF;
?><?php $policymsgs .= $p.$policymsg;$p = ', ';?><?php } if($policymsgs) { ?><p>Every single search will be deducted <?php echo $policymsgs;?></p><?php } ?>
</form>

<?php if(!empty($searchid) && submitcheck('searchsubmit', 1)) { ?><div class="tl">
<div class="sttl mbn">
<h2><?php if($keyword) { ?>Result: <em>Find "<?php echo $keyword;?>" Related Topics <?php echo $index['num'];?></em> <?php if($modfid) { ?><a href="forum.php?mod=modcp&amp;action=thread&amp;fid=<?php echo $modfid;?>&amp;keywords=<?php echo $modkeyword;?>&amp;submit=true&amp;do=search&amp;page=<?php echo $page;?>" target="_blank">Into the manage panel</a><?php } } else { ?>Result: <em>Find Related Topics <?php echo $index['num'];?></em><?php } ?></h2>
</div><?php echo adshow("search/y mtw");?><?php if(empty($threadlist)) { ?>
<p class="emp xs2 xg2">Sorry, no matches were found.</p>
<?php } else { ?>
...
<p class="xg1"><?php echo $thread['replies'];?>  Replies - <?php echo $thread['views'];?>  Views</p>
<p><?php if(!$thread['price'] && !$thread['readperm']) { ?><?php echo $thread['message'];?><?php } else { ?>Content Hidden need, please click inside view<?php } ?></p>
<p>
...
<?php } else { if($_G['forum']['ismoderator']) { ?><a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" target="_blank">Anonymous</a><?php } else { ?>Anonymous<?php } } ?>
</span>
 -
...
<div class="bm">
<div class="bm_h cl">
<a href="javascript:;" onclick="setcookie('nofocus_<?php echo $focusid;?>', 1, <?php echo $_G['cache']['focus']['cookie'];?>*3600);$('focus').style.display='none'" class="y" title="Close">Close</a>
<h2><?php if($_G['cache']['focus']['title']) { ?><?php echo $_G['cache']['focus']['title'];?><?php } else { ?>Master recommended<?php } ?></h2>
</div>
<div class="bm_c">
...
<p class="ptn hm"><a href="<?php echo $focus['url'];?>" class="xi2" target="_blank">View &raquo;</a></p>
</div>
</div>
</div>
