...
<p class="chart z">Today: <em><?php echo $todayposts;?></em><span class="pipe">|</span>Yesterday: <em><?php echo $postdata['0'];?></em><span class="pipe">|</span>Posts: <em><?php echo $posts;?></em><span class="pipe">|</span>Member: <em><?php echo $_G['cache']['userstats']['totalmembers'];?></em><?php if($_G['cache']['userstats']['newsetuser']) { ?><span class="pipe">|</span>Welcome new members: <em><a href="home.php?mod=space&amp;username=<?php echo rawurlencode($_G['cache']['userstats']['newsetuser']); ?>" target="_blank" class="xi2"><?php echo $_G['cache']['userstats']['newsetuser'];?></a></em><?php } ?></p>
<div class="y">
<?php if(!empty($_G['setting']['pluginhooks']['index_nav_extra'])) echo $_G['setting']['pluginhooks']['index_nav_extra'];?>
<?php if($_G['uid']) { ?><a href="forum.php?mod=guide&amp;view=my" title="My Posts" class="xi2">My Posts</a><?php } if(!empty($_G['setting']['search']['forum']['status'])) { if($_G['uid']) { ?><span class="pipe">|</span><?php } ?><a href="forum.php?mod=guide&amp;view=new" title="Last Reply" class="xi2">Last Reply</a><?php } ?>
</div>
</div>
<?php } ?>
...
<div class="newimgbox">
<h4><span class="tit_newimg"></span>New images</h4>
...
<h4><span class="tit_subject"></span>Latest topic</h4>
...
<div class="replaybox">
<h4><span class="tit_replay"></span>Last Reply</h4>
        <ul class="category_newlist">
...
<td valign="top" class="category_l3">
<div class="hottiebox">
<h4><span class="tit_hottie"></span>Hot Posts</h4>
        <ul class="category_newlist">
...
<h4><span class="tit_goodtie"></span>Digest Topics</h4>
...
<div class="bm">
<div class="bm_h cl">
<h2><?php echo $_G['setting']['navs']['2']['navname'];?> Hot spot</h2>
</div>
<div class="bm_c cl">
...
<h2><a href="forum.php?mod=collection&amp;op=my">I subscribe to the Amoy album</a></h2>
</div>
...
<dd><em>Theme: <?php echo dnumber($colletion['threadnum']); ?></em>, <em>Comment: <?php echo dnumber($colletion['commentnum']); ?></em></dd>
<dd>
...
<h2><a href="home.php?mod=space&amp;do=favorite&amp;type=forum">My Favorites Forum</a></h2>
</div>
...
<?php if(empty($forum['redirect'])) { ?><dd><em>Theme: <?php echo dnumber($forum['threads']); ?></em>, <em> Posts: <?php echo dnumber($forum['posts']); ?></em></dd><?php } ?>
<dd>
...
<?php if($forum['description']) { ?><p class="xg2"><?php echo $forum['description'];?></p><?php } if($forum['subforums']) { ?><p>Sub-forum: <?php echo $forum['subforums'];?></p><?php } if($forum['moderators']) { ?><p>Moderator: <span class="xi2"><?php echo $forum['moderators'];?></span></p><?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['index_favforum_extra'][$forum[fid]])) echo $_G['setting']['pluginhooks']['index_favforum_extra'][$forum[fid]];?>
</td>
<td class="fl_i">
...
<?php if($cat['moderators']) { ?><span class="y">Zoning Moderator: <?php echo $cat['moderators'];?></span><?php } $caturl = !empty($cat['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$cat['domain'].'.'.$_G['setting']['domain']['root']['forum'] : '';?><h2><a href="<?php if(!empty($caturl)) { ?><?php echo $caturl;?><?php } else { ?>forum.php?gid=<?php echo $cat['fid'];?><?php } ?>" style="<?php if($cat['extra']['namecolor']) { ?>color: <?php echo $cat['extra']['namecolor'];?>;<?php } ?>"><?php echo $cat['name'];?></a></h2>
</div>
...
<h2><a href="forum.php?mod=collection">The Amoy album recommended</a></h2>
</div>
...
<h3>
<strong><a href="home.php?mod=space&amp;do=friend&amp;view=online&amp;type=member">Online members</a></strong>
<span class="xs1">- <strong><?php echo $onlinenum;?></strong>  Are online
- <strong><?php echo $membercount;?></strong> Member(<strong><?php echo $invisiblecount;?></strong> Stealth),
<strong><?php echo $guestcount;?></strong>  Guests
- Highest record <strong><?php echo $onlineinfo['0'];?></strong> On <strong><?php echo $onlineinfo['1'];?></strong>.</span>
</h3>
...
Online members
<?php } else { ?>
<a href="home.php?mod=space&amp;do=friend&amp;view=online&amp;type=member">Online members</a>
<?php } ?>
</strong>
<span class="xs1">- Total <strong><?php echo $onlinenum;?></strong>  Are online
<?php if($membercount) { ?>- <strong><?php echo $membercount;?></strong> Member,<strong><?php echo $guestcount;?></strong>  Guests<?php } ?>
- Highest record <strong><?php echo $onlineinfo['0'];?></strong> On <strong><?php echo $onlineinfo['1'];?></strong>.</span>
</h3>
<?php } ?>
</div>
